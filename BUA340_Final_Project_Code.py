...
print('Email group:',email_mean)
print('No email group:',no_email_mean)
...
print('Urban')
print('Email Effect β̂',urban_model.params['got_email'])
print('Standard Error',urban_model.bse['got_email'])
...
print('Suburban')
print('Email Effect β̂',suburban_model.params['got_email'])
print('Standard Error',suburban_model.bse['got_email'])
...
print('Rural')
print('Email Effect β̂',rural_model.params['got_email'])
print('Standard Error',rural_model.bse['got_email'])
...
print('RCT', beta_hat)
print('Nearest Neighbor Matching', beta_match)
